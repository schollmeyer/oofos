...
#' with a positive objective value 'objective' will lead to the same optimization
#' problem as if one would optimize over the concept lattice generated by all
#' objects reference: TODO

optimize_on_context_extents <- function(context, gen_index=(1:nrow(context)),
  ...
  return(list(A = simple_triplet_matrix(I[jj], J[jj], V[jj], nrow = t,
              ...
              obj = c(objective, rep(0, n_cols)), ext_obj = objective, intent_obj = rep(0, n_cols),
